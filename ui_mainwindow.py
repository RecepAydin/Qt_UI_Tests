...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.pitch, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.language, 4, 1, 1, 1)

        self.voice = QComboBox(self.centralwidget)
        self.voice.setObjectName(u"voice")

        self.gridLayout.addWidget(self.voice, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.engine, 3, 1, 1, 1)
